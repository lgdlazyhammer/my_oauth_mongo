...
app.use('/oauth/resource', function(req, response) {
    ...
    if (req.method == 'POST'){
        ...
        var postData = querystring.stringify({'resource_token' : resource_token, 'resource_type':'' });
        ...
        var req = http.request(options, (res) => {
            ...
            res.on('end', () => {
                ...
                if(res.statusCode == 200){
                    ...
                    // 数据以json形式返回
                    console.log(resource_approval);
                    var temp = { resource_url : 'http://localhost:5000/imgs/max.png' };
